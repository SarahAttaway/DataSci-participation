...
```{r}
flights_airlines <- full_join(flights, airlines, by = "carrier")

flights_airlines %>% 
  rename(airline_name = name) %>% 
  -

flight_airline_weather <- full_join(flights_airlines, weather, by = c("origin", "year", "month", "day", "hour", "time_hour"))

full_join(flight_airline_weather, planes, by = c("tailnum", "year"))
